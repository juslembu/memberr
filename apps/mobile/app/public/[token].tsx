...
const styles = StyleSheet.create({
  ...
  errorMsg: { fontSize: 15, color: '#64748B', textAlign: 'center', lineHeight: 22, marginBottom: 40 },
  memberrFooterError: { fontSize: 12, color: '#94A3B8' },
  hero: {
    padding: 28,
    paddingTop: 60,
    paddingBottom: 28,
  ...
  barcodeType: { fontSize: 11, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1.5 },
  cardNumberLarge: { fontSize: 20, fontWeight: '700', color: '#0F172A', letterSpacing: 3 },
  instructionSection: {
    backgroundColor: '#fff', marginTop: 1, padding: 20, gap: 14,
  },
  instructionRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  instructionText: { fontSize: 14, color: '#475569', flex: 1 },
  footer: {
    alignItems: 'center', paddingTop: 40, paddingBottom: 20, gap: 4,
  },
  footerText: { fontSize: 12, color: '#94A3B8' },
  footerBrand: { fontSize: 18, fontWeight: '800', color: '#0EA5E9', letterSpacing: -0.3 },
